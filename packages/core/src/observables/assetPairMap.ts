...
/** @internal */
export const assetPairMap$ = new BehaviorSubject<Map<string, IAssetPair>>(new Map([]));
export const assetPairMapø = assetPairMap$.pipe<Map<string, IAssetPair>>(share());
...
export const updatePair = async (baseId: string, ilkId: string) => {
