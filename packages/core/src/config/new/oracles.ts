...
const CHAIN_ID_42_ASSET_ORACLE_INFO = new Map<string, Map<string, string>>();
const CHAIN_ID_42161_ASSET_ORACLE_INFO = new Map<string, Map<string, string>>();
const CHAIN_ID_421611_ASSET_ORACLE_INFO = new Map<string, Map<string, string>>();
