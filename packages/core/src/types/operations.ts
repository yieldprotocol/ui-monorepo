...
export namespace ModuleActions {
  ...
  export namespace Args {
    export type WRAP_ETHER = [receiver: string, amount: BigNumberish];
    export type ADD_CONVEX_VAULT = [convexJoin: string, vaultId: string]; // when using convex-type collateral
  }
}
