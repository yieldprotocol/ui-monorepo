 ...
 * @category Borrow
 * */
export declare const maxDebtLimitø: Observable<W3Number>;
/**
 * Minimum amount of debt allowed by the protocol ( Dust level ) for a particular [[IAssetPair | Asset Pair]]
 * @category Borrow
 * */
export declare const minDebtLimitø: Observable<W3Number>;
/**
