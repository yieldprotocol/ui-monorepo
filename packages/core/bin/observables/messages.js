 ...
 * @internal
 **/
exports.internalMessagesø = messages$.pipe((0, rxjs_1.filter)((msg) => !!msg && msg.type === types_1.MessageType.INTERNAL), (0, rxjs_1.scan)((acc, curr) => acc.set(curr.id, curr), new Map([])));
