...
const buildAssetMap = (cauldron, ladle, provider, chainId, appConfig) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const assetList = (appConfig.browserCaching && (0, appUtils_1.getBrowserCachedValue)(`${chainId}_assets`)) || [];
    /* Check the last time the assets were fetched */
    const lastAssetUpdate = (appConfig.browserCaching && (0, appUtils_1.getBrowserCachedValue)(`${chainId}_lastAssetUpdate`)) || 'earliest';
...
//# sourceMappingURL=buildAssetsRoot.js.map