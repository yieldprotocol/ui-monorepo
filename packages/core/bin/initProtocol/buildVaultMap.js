...
const buildVaultMap = (yieldProtocol, account, browserCaching = true) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const cachedVaults = (browserCaching && (0, appUtils_1.getBrowserCachedValue)(`${observables_1.chainId$.value}_vaults#${account}`)) || [];
    /* Check the last time the assets were fetched */
    const lastVaultUpdate = (browserCaching && (0, appUtils_1.getBrowserCachedValue)(`${observables_1.chainId$.value}_lastVaultUpdate#${account}`)) || 'earliest';
    ...
    (0, appUtils_1.setBrowserCachedValue)(`${observables_1.chainId$.value}_vaults#${account}`, vaultList);
    // Set the 'last checked' block
    // const _blockNum = await provider.getBlockNumber(); // TODO: maybe lose this
    (0, appUtils_1.setBrowserCachedValue)(`${observables_1.chainId$.value}_lastVaultUpdate#${account}`, 1);
