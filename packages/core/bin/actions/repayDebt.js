...
const repayDebt = (amount, vault, reclaimCollateral) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, rxjs_1.combineLatest)([observables_1.yieldProtocolø, observables_1.chainIdø, observables_1.assetMapø, observables_1.seriesMapø, observables_1.accountø, observables_1.userSettingsø, observables_1.providerø])
        ...
        const _amountAsFyToken = series.isMature()
            ? _amount
            : (0, ui_math_1.sellBase)(series.baseReserves, series.fyTokenReserves, _amount, (0, ui_math_1.secondsToFrom)(series.maturity.toString()), series.ts, series.g1, series.decimals);
        ...
        const amountGreaterThanEqualDebt = ethers_1.ethers.BigNumber.from(_amountAsFyToken).gte(vault.accruedArt);
        /* If requested, and all debt will be repaid, automatically remove collateral */
        const _collateralToRemove = reclaimCollateral && amountGreaterThanEqualDebt ? vault.ink.mul(-1) : ethers_1.ethers.constants.Zero;
        ...
        const _amountCappedAtArt = vault.art.gt(constants_1.ZERO_BN) && vault.art.lte(_amount) ? vault.art : _amount;
