...
const rollLend = (amount, fromSeries, toSeries) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const _fyTokenValueOfInput = seriesIsMature
        ? _amount
        : (0, ui_math_1.buyBase)(fromSeries.baseReserves, fromSeries.fyTokenReserves, _amount, fromSeries.getTimeTillMaturity(), fromSeries.ts, fromSeries.g2, fromSeries.decimals);
